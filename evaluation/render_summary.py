...
def render_svg(summary: dict[str, Any]) -> str:
  ...
  <text x="72" y="154" class="card-title">Workflow change</text>
  <text x="72" y="184" class="body">Before: direct repo exploration</text>
  <text x="72" y="204" class="fine">Broad reads stay in solver history.</text>
  <text x="520" y="184" class="body">After: delegated FastContext exploration</text>
  <text x="520" y="204" class="fine">File-line citations go back to the solver.</text>
